...
from SSLBackbone_setup.token_reduc.merge import bipartite_soft_matching, agglomerative_clustering
...
def apply_patch(
    model: VisionTransformer, merge_type: str = "tome", linkage: str = "average", trace_source: bool = False, prop_attn: bool = False
):
    """
